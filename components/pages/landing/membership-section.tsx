...
//   // Fallback static plans (optional) in case of loading/error
//   if (error) {
...
//       const isFeatured = plan.plan === "ANNUAL" // You can change featured logic
...
//         period: isAnnual ? "/year" : plan.plan === "MONTHLY" ? "/month" : "",
//         featured: isFeatured,
//         highlight: isFeatured ? "Best Value • Save 20%" : undefined,
//         points: getPlanPoints(plan.plan), // Helper function below
//         cta: plan.plan === "CASUAL" ? "Get Started Free" : "Subscribe Now",
//         // Pass raw data if needed later
//         rawPlan: plan.plan,
...
// // Helper function for plan benefits
...
// // Subscribe handler (you can expand this later)
...
//   // Navigate to payment or open modal with plan
//   // Example: router.push(`/membership/checkout?plan=${plan.rawPlan}`);
//   console.log(`Subscribe to ${plan.rawPlan} plan`)
// }
